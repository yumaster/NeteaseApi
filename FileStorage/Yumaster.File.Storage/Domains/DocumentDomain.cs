...
namespace Yumaster.File.Storage.Domains
{
    public class DocumentDomain:IDocumentDomain
    {
        ...
        public DocumentDomain(IDocumentRepository documentRepository)
        {
            ...
            rootPath2 = AppSettingB.GetValueByKey("path");//2017-07-01新加
        }
        ...
        private bool SaveDisk(string filePath, string[] chunkFiles)
        {
            ...
            using (Stream stream = new FileStream(filePath, FileMode.Create, FileAccess.Write))
            {
                ...
                {
                    using (Stream input = System.IO.File.OpenRead(chunkFile))
                    {
                        input.CopyTo(stream);
                    }
                }
        ...
        public SubFolderModel UnCompress(dynamic document, string qyCode)
        {
            ...
            using (var zipInputStream = new ZipInputStream(System.IO.File.OpenRead(file)))
            {
                ...
                while ((zipEntry = zipInputStream.GetNextEntry()) != null)
                {
                    ...
                    using (FileStream stream = System.IO.File.Create(fileUnzipName))
                    {
        ...
        public string GetUnZipFile(string md5, string name)
        {
            ...
            if (System.IO.File.Exists(unzipname))
                return unzipname;
            return "";
        }
